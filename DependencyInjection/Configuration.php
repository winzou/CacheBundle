    ...
    public function getConfigTree()
    {
        ...
        $rootNode
			...
			->scalarNode('abstract')    ->defaultValue('winzou\\CacheBundle\\Cache\\AbstractCache')    ->end()
                        ...
                        ->scalarNode('file')        ->defaultValue('winzou\\CacheBundle\\Cache\\LifetimeFileCache')->end()
                        ->scalarNode('lifetimefile')->defaultValue('winzou\\CacheBundle\\Cache\\FileCache')        ->end()
